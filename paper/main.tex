...
but toward the nearest smooth, quasi-periodic Risley curve.  The final
result~(e) is a looped pattern that approximates the overall shape but
cannot reproduce the corners; the MSE floors at $\sim\!2.8$, reflecting
the irreducible distance between the input and the Risley manifold
$\mathcal{M}_3$.  The overlay~(f) makes the discrepancy visible: the
black input has straight edges while the red Risley fit is smooth
everywhere---exactly the $C^\infty$ constraint predicted by the theory.
