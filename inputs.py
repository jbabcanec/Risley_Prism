...
STARTTHETAX = 30             		# Initial laser angle with respect to x-axis		# [0,90) 		# degrees
STARTTHETAY = 45              		# Initial laser angle with respect to y-axis		# [0,90) 		# degrees
STARTPHIX = [15, 20, 25]			# Angles from wedges' x-axis projection & z-axis 	# (-90,90) 		# degrees
...
D = 5                       		# Wedge diameter									# (0,+inf)		# unit length
int_dist = [2, 3, 4]				# Optical axis distance between interfaces 			# (0*,+inf)		# unit length
int_dist.append(5)        			# Distance from last wedge to workpiece 			# (0*,+inf)		# unit length
